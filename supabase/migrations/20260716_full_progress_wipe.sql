-- Full system progress wipe (keep schema + lessons content in app code)
-- Project: codefxnhkhorpwutnxdp
-- Run in Supabase → SQL Editor if not already applied

-- 1) Future signups start from zero
...
set status = 'locked', progress = 0, updated_at = now();
